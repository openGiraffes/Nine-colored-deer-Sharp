...
namespace Nine_colored_deer_Sharp.utils
{
    public class AnimationHelper
    {
        ...
        #region (Event) 
        public static readonly RoutedEvent CompletedEvent = EventManager.RegisterRoutedEvent("Completed", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(UIElement));
        ...
        public static void RaiseCompleted(UIElement uie)
        {
